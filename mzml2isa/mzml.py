...
class MzMLFile(object):
    ...
    def _scan_parameters(cls):
        ...
        terms['scan_sp'] = terms['ref_sp'] = {
            _CVParameter(accession='MS:1000524', cv=True, name='Data file content', plus1=True, value=False, software=False),
            _CVParameter(accession='MS:1000796', cv=False, name='Spectrum title', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000465', cv=True, name='Polarity', plus1=True, value=False, software=False),
            _CVParameter(accession='MS:1000511', cv=False, name='MS Level', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000525', cv=True, name='Spectrum representation', plus1=True, value=False, software=False),
            _CVParameter(accession='MS:1000504', cv=False, name='Base Peak m/z', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000505', cv=False, name='Base Peak intensity', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000285', cv=False, name='Total ion current', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000927', cv=False, name='Ion injection time', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000512', cv=False, name='Filter string', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000528', cv=False, name='Lowest observed m/z', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000527', cv=False, name='Highest observed m/z', plus1=True, value=True, software=False),
        }

        terms['scan_combination'] = terms['ref_combination'] = {
            _CVParameter(accession='MS:1000570', cv=True, name='Spectrum combination', plus1=True, value=False, software=False)
        }

        terms['scan_configuration'] = {
            _CVParameter(accession='MS:1000016', cv=False, name='Scan start time', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000512', cv=False, name='Filter string', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000616', cv=False, name='Preset scan configuration', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000927', cv=False, name='Ion injection time', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000018', cv=True, name='Scan direction', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000019', cv=True, name='Scan law', plus1=True, value=True, software=False),
        }

        terms['scan_isolation_window'] = {
            _CVParameter(accession='MS:1000827', cv=False, name='Isolation window target m/z', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000828', cv=False, name='Isolation window lower offset', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000829', cv=False, name='Isolation window higher offset', plus1=True, value=True, software=False),
        }

        terms['scan_selected_ion'] = {
            _CVParameter(accession='MS:1000744', cv=False, name='Selected ion m/z', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000041', cv=False, name='Charge state', plus1=True, value=True, software=False),
            _CVParameter(accession='MS:1000042', cv=False, name='Peak intensity', plus1=True, value=True, software=False),
        }

        terms['scan_activation'] = {
            _CVParameter(accession='MS:1000044', cv=True, name='Dissociation method', plus1=True, value=False, software=False),
            _CVParameter(accession='MS:1000045', cv=False, name='Collision Energy', plus1=True, value=True, software=False),
        }

        terms['scan_binary'] = terms['ref_binary'] = {
            _CVParameter(accession='MS:1000518', cv=True, name='Binary data type', plus1=True, value=False, software=False),
            _CVParameter(accession='MS:1000572', cv=True, name='Binary data compression type', plus1=True, value=False, software=False),
            _CVParameter(accession='MS:1000513', cv=True, name='Binary data array', plus1=True, value=False, software=False),
        }
    ...
    def _extract_generic_parameters(self, meta):
        terms = self._generic_parameters()
    ...
    def _collect_scan_info(self, meta):
    ...
    def metadata(self):
        ...
        self._extract_generic_parameters(meta)
